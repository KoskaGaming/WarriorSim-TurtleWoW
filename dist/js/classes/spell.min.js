...
class DeepWounds extends Aura {
    ...
    step() {
        while (step >= this.nexttick) {
            ...
            /* start-log */ if (this.player.logging) this.player.log(`New ${this.name} tick for ${dmg.toFixed(2)}`); /* end-log */
        ...
        if (step >= this.timer) {
            ...
            this.saveddmg = 0;
            this.player.updateDmgMod();
            /* start-log */ if (this.player.logging) this.player.log(`New ${this.name} removed`); /* end-log */
        }
    }
    use(offhand) {
        if (this.timer) this.uptime += (step - this.starttimer);
        ...
        this.starttimer = step;
        this.player.updateDmgMod();
        /* start-log */ if (this.player.logging) this.player.log(`New ${this.name} applied`); /* end-log */
    }
}
...
class OldDeepWounds extends Aura {
    ...
    step() {
        while (step >= this.nexttick) {
            ...
            /* start-log */ if (this.player.logging) this.player.log(`Old ${this.name} tick for ${(dmg / 4).toFixed(2)}`); /* end-log */
    ...
    use() {
        ...
        this.timer = step + this.duration * 1000;
        this.starttimer = step;
        /* start-log */ if (this.player.logging) this.player.log(`Old ${this.name} applied`); /* end-log */
    }
}
